...
///
/// Since chantier 1.6.2, both `decode_cdr2_le_at` (REQUIRED, spec-aligned,
/// propagates the global offset) and `decode_cdr2_le` (legacy, sub-buffer
/// at offset 0) must be provided. Generated code emits `decode_cdr2_le`
/// as a trivial wrapper around `decode_cdr2_le_at` starting at offset 0.
///
/// ```ignore
